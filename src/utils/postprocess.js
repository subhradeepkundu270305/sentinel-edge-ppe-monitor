...
export const CLASS_NAMES = [
  // Placeholder: COCO classes from the stock pretrained model used for the
  // Phase 0 feasibility spike. Replace with your trained PPE class list,
  // e.g. ['helmet', 'no-helmet', 'vest', 'no-vest', 'gloves', 'person'].
  'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck',
  'boat', 'traffic light', 'fire hydrant', 'stop sign', 'parking meter', 'bench',
  'bird', 'cat', 'dog', 'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra',
  'giraffe', 'backpack', 'umbrella', 'handbag', 'tie', 'suitcase'
  // ...truncated for brevity; full 80-class COCO list works fine for the spike.
];
